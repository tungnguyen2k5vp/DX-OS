...
var (
	...
	ErrSourcingAwardRequired    = errors.New("supplier quote award is required")
	...
	ErrApprovalRuleNotFound     = errors.New("approval rule not found")
	ErrApprovalRuleVersion      = errors.New("approval rule version conflict")
	ErrDelegationNotFound       = errors.New("approval delegation not found")
	ErrDelegationConflict       = errors.New("approval delegation conflict")
	ErrDelegationVersion        = errors.New("approval delegation version conflict")
	ErrSourcingCaseNotFound     = errors.New("sourcing case not found")
	ErrSupplierQuoteNotFound    = errors.New("supplier quote not found")
	ErrSupplierQuoteVersion     = errors.New("supplier quote version conflict")
	ErrInvalidSourcingAction    = errors.New("sourcing action is invalid")
